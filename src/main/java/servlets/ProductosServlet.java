...
public class ProductosServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case "delete": eliminarProducto(req, resp); break;
	...
	protected void registrarProducto(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
...
//        resp.setCharacterEncoding("UTF-8");
	...
	protected void editarProducto(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// Entradas
	...
	protected void eliminarProducto(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		String id = req.getParameter("idProducto");
